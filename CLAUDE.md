...
- src/components/os/PossibilityHorizon.tsx — Decide view: Netflix-style category sections with horizontal card bands. No input — shared ChatInput from Space page. DecisionCard (170×220 portrait + reaction row below on void). Self-resolving: locked categories collapse to green dot.
