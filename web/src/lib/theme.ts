...
export interface ThemeConfig {
  ...
  // Chat bubble colors
  bubbleReceived: string;  // incoming messages — off-white (light) / dark surface (dark)
  bubbleSent: string;      // outgoing messages — gray (light) / darker surface (dark)
  bubbleTextReceived: string;
  bubbleTextSent: string;
}
...
export const themes: Record<ThemeName, ThemeConfig> = {
  ...
  hearth: {
    ...
    inkTertiary: "#A1A1A6",
    inkSender: "#9E6A06",
    surfaceChrome: "#FAFAFA",    // Matches canvas
    surfaceCanvas: "#FAFAFA",    // Clean white
    surfaceRecessed: "#F0F0F0",  // Neutral light gray (input pill, avatars)
    bubbleReceived: "#FFFFFF",
    bubbleSent: "#F0F0F0",
    bubbleTextReceived: "#1A1A1A",
    bubbleTextSent: "#1A1A1A",
  },
  hearth_dark: {
    label: "hearth_dark",
    mode: "dark",
    style: "flat",
    accent: "#FF6B35",           // Searing Action Orange
    cyan: "#FF6B35",             // Liquid Fire
    text: "#F8F7F4",             // Cloud Dancer
    bg: "#111111",               // Deep Space
    amber: "#9E6A06",
    gold: "#8B6914",
    green: "#047857",
    orange: "#C43D08",
    ...
    inkTertiary: "#71717A",
    inkSender: "#FCD34D",
    surfaceChrome: "#1A1A1A",
    surfaceCanvas: "#111111",
    surfaceRecessed: "#000000",
    bubbleReceived: "#1E1E1E",
    bubbleSent: "#2A2A2A",
    bubbleTextReceived: "#F8F7F4",
    bubbleTextSent: "#F8F7F4",
  },
  // ── VIBE: Deep Glass Mode (Immersive, depth, reflections) ──
  vibe: {
    label: "vibe",
    mode: "light",
    style: "depth",
    ...
    cyan: "#FF6B35",
    text: "#111111",
    bg: "#F5F5F5", // clean neutral — differentiates from Hearth via depth style, not warmth
    amber: "#9E6A06",
    gold: "#8B6914",
    green: "#047857",
    orange: "#C43D08",
    ...
    surfaceRecessed: "#E5E5E5",
    bubbleReceived: "#FFFFFF",
    bubbleSent: "#E5E5E5",
    bubbleTextReceived: "#111111",
    bubbleTextSent: "#111111",
  },
  vibe_dark: {
    label: "vibe_dark",
    mode: "dark",
...
export const neuro = {
  ...
  cyan: { hex: colors.cyan, signal: "@hello Intelligence", breathDuration: timing.breath },
} as const;
