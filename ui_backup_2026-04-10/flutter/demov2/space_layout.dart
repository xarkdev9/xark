  ...
  void _openAddSheet() {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => AddItemSheet(
        ...
        onSubmit: (title, category, photoUrl) async {
          ...
          final decisionEngine = engine as ChatEngineDecisions;
          final encrypted = await decisionEngine.encryptPayload(
            groupId: widget.spaceId,
            plaintext: payloadStr,
          );

          await decisionEngine.addDecisionItem(
            widget.spaceId,
            ciphertextPayload: encrypted['ciphertextPayload']!,
