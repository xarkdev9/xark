...
async function runTests() {
  ...
  const dateIntent = await intentParser.parseSpotlightQuery("@hello set dates to june 1-5");
  ...
  const renameIntent = await intentParser.parseSpotlightQuery("@hello rename space to Tahoe 2026");
