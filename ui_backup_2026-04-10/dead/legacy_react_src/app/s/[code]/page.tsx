...
import { ink, surface, colors, textColor } from "@/lib/theme";
...
export default function SummonPage() {
  ...
  const verifyOtp = useCallback(async () => {
    ...
    try {
      ...
      if (displayName && !/^\d+$/.test(displayName)) {
        ...
        (window as unknown as Record<string, unknown>)["__hello_summon_token"] = firebaseToken;
        setPhoneAction("idle");
        setAuthStep("name");
      }
    } catch {
  ...
  const submitName = useCallback(async () => {
    ...
    const storedToken = (window as unknown as Record<string, unknown>)["__hello_summon_token"] as
      | string
      | undefined;
    if (!storedToken) {
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                    ...
                    >
                      ...
                      <svg
                        ...
                        viewBox="0 0 8 8"
                        fill="none"
                        style={{ opacity: 0.7, marginTop: "2px", color: ink.primary }}
                      >
                        <path
                          d="M2 3L4 5L6 3"
                          stroke="currentColor"
                    ...
                    {filteredCodes.slice(0, 10).map((c) => (
                      <div
                        ...
                        style={{
                          ...
                          padding: "10px 0",
                          borderBottom: `1px solid ${textColor(0.12)}`,
                        }}
                      >
                        <span
                          style={{
