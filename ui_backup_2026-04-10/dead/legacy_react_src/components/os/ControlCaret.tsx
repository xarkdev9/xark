...
export function ControlCaret() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const dismissed = localStorage.getItem("hello_spotlight_hint_dismissed");
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          transform: isKeyboardOpen ? "translateY(20px) translateZ(0)" : "translateY(0) translateZ(0)",
          WebkitTransform: isKeyboardOpen ? "translateY(20px) translateZ(0)" : "translateY(0) translateZ(0)",
      ...
      >
              ...
              <div
                ...
                onPointerUp={() => {
                  ...
                  if (!isLongPress.current) {
                    if (showHint) {
                      localStorage.setItem("hello_spotlight_hint_dismissed", "1");
                      setShowHint(false);
                    }
                    spotlight.open();
                  }
            ...
            {/* ── RIGHT THUMB: (Relocated + to the Header) ── */}
