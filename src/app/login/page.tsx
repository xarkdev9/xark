...
export default function LoginPage() {
  ...
  return (
    <LayoutGroup>
      <div className="relative flex min-h-svh flex-col overflow-hidden" style={{ background: "#F0EEE9" }}>
            ...
            >
              ...
              <div style={{ marginTop: "36px" }}>
                <motion.p
                  ...
                  style={{ fontSize: "14px", fontWeight: 400, color: "#141414", lineHeight: 2, letterSpacing: "0.02em" }}
                >
            ...
            >
                ...
                <AnimatePresence mode="wait">
                  ...
                  {fieldStep === "phone" && !showPicker && (
                    <motion.div key="phone" {...fieldTransition}>
                      {usePhoneAuth ? (
                        <>
                          <p style={{ fontSize: "13px", fontWeight: 300, color: "#141414", opacity: 0.25, letterSpacing: "0.04em", marginBottom: "16px" }}>
                            your number
                          </p>
                          <div style={{ display: "flex", alignItems: "center" }}>
                            ...
                            >
                              <span style={{ fontSize: "22px", fontWeight: 400, color: "#141414", opacity: 0.5 }}>{countryCode}</span>
                              <svg width="8" height="8" viewBox="0 0 8 8" fill="none" style={{ opacity: 0.2, marginTop: "2px" }}>
                                <path d="M2 3L4 5L6 3" stroke="#141414" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"/>
                              </svg>
                              <div style={{ position: "absolute", right: 0, top: "4px", bottom: "4px", width: "1px", background: "#141414", opacity: 0.06 }} />
                            </div>
                            ...
                            <input
                              ...
                              style={{
                                fontSize: "22px", fontWeight: 400, color: "#141414", letterSpacing: "0.06em",
                        ...
                        <>
                          ...
                          <div style={{ display: "flex", alignItems: "center", marginBottom: "24px" }}>
                            <input
                              ...
                              className="flex-1 bg-transparent outline-none"
                              style={{ fontSize: "22px", fontWeight: 400, color: "#141414", letterSpacing: "0.04em", caretColor: "#FF6B35" }}
                            />
                          </div>
                          <p style={{ fontSize: "13px", fontWeight: 300, color: "#141414", opacity: 0.15, letterSpacing: "0.04em", marginBottom: "16px" }}>
                            password
                          </p>
                          <div style={{ display: "flex", alignItems: "center" }}>
                            <input
                              ...
                              className="flex-1 bg-transparent outline-none"
                              style={{ fontSize: "16px", fontWeight: 400, color: "#141414", letterSpacing: "0.08em", caretColor: "#FF6B35", opacity: 0.6 }}
                            />
                            <span
                              role="button" tabIndex={0}
                  ...
                  {fieldStep === "phone" && showPicker && (
                    <motion.div key="picker" {...fieldTransition}>
                      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "20px" }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#141414" strokeWidth="1.5" opacity="0.2">
                        ...
                        <input
                          ...
                          className="flex-1 bg-transparent outline-none"
                          style={{ fontSize: "15px", fontWeight: 400, color: "#141414", letterSpacing: "0.02em", caretColor: "#FF6B35" }}
                        />
                        <span
                          role="button" tabIndex={0}
                          ...
                          className="cursor-pointer outline-none"
                          style={{ fontSize: "11px", fontWeight: 300, color: "#141414", opacity: 0.2 }}
                        >
                          cancel
                        </span>
                      </div>
                      <div style={{ maxHeight: "280px", overflowY: "auto" }}>
                        {filteredCodes.slice(0, 10).map((c) => (
                          ...
                          >
                            <span style={{ fontSize: "14px", fontWeight: 400, color: "#141414", opacity: 0.6 }}>{c.name}</span>
                  ...
                  {fieldStep === "otp" && (
                    <motion.div key="otp" {...fieldTransition}>
                      <p style={{ fontSize: "13px", fontWeight: 300, color: "#141414", opacity: 0.2, letterSpacing: "0.04em", marginBottom: "16px" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center" }}>
                        <input
                          ...
                          className="flex-1 bg-transparent outline-none"
                          style={{
                            fontSize: "32px", fontWeight: 400, color: "#141414", letterSpacing: "0.3em",
                            caretColor: "#FF6B35",
                    ...
                    <motion.div key="name" {...fieldTransition}>
                      ...
                      <div style={{ display: "flex", alignItems: "center" }}>
                        <input
                          ...
                          autoFocus spellCheck={false} autoComplete="off"
                          className="flex-1 bg-transparent outline-none"
                          style={{ fontSize: "26px", fontWeight: 400, color: "#141414", letterSpacing: "0.02em", caretColor: "#FF6B35", opacity: 0.88 }}
                        />
                        <span
                          role="button" tabIndex={0}
                    ...
                    <motion.div key="photo" {...fieldTransition}>
                      ...
                      {!photoUploading ? (
                        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
                          ...
                          >
                            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" style={{ position: "absolute", inset: 0 }}>
                              <circle cx="28" cy="28" r="26" stroke="#141414" strokeWidth="0.6" strokeDasharray="4 5" opacity="0.12"/>
                            </svg>
                            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                              <svg width="14" height="14" viewBox="0 0 16 16" fill="none" opacity="0.15">
                                <line x1="8" y1="3" x2="8" y2="13" stroke="#141414" strokeWidth="0.8"/>
                                <line x1="3" y1="8" x2="13" y2="8" stroke="#141414" strokeWidth="0.8"/>
                              </svg>
                            </div>
                          </div>
                          <span
                            ...
                            className="cursor-pointer outline-none"
                            style={{
                              fontSize: "11px", fontWeight: 300, color: "#141414", opacity: 0.12, letterSpacing: "0.04em",
                              transition: `opacity ${timing.transition} ease`,
                            }}
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                          ...
                          <span style={{ fontSize: "12px", fontWeight: 300, color: "#141414", opacity: 0.35 }}>uploading</span>
                        </div>
                      )}
                    </motion.div>
                  )}
              ...
              {isDevMode && !!auth && fieldStep === "phone" && !showPicker && (
                <span
                  ...
                  className="cursor-pointer outline-none"
                  style={{
                    fontSize: "10px", fontWeight: 300, color: "#141414", opacity: 0.12, letterSpacing: "0.04em",
              ...
              <div style={{ position: "fixed", bottom: "56px", left: "36px", display: "flex", alignItems: "center", gap: "6px", zIndex: 10 }}>
                <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
                  <path d="M6 1L3 3.5V5.5C3 7.98 4.28 10.28 6 11C7.72 10.28 9 7.98 9 5.5V3.5L6 1Z" stroke="#141414" strokeWidth="0.8" strokeLinejoin="round" opacity="0.15"/>
                </svg>
                <span style={{ fontSize: "8px", letterSpacing: "0.12em", color: "#141414", opacity: 0.12, textTransform: "uppercase" }}>
                  encrypted
                </span>
              </div>
            </motion.div>
