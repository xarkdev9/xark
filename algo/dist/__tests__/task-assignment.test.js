...
import { createTask, assignTask, reassignTask, unassignTask, resetTaskCounter, TaskAssignmentError, } from "../engine/task-assignment.js";
...
describe("reassignTask", () => {
    ...
    it("throws if reassigning to same user", () => {
        const task = createTask("g1", "Bring snacks", "", "u1", 1000);
        const assigned = assignTask(task, "u2", 2000);
        expect(() => reassignTask(assigned, "u2", 3000)).toThrow(TaskAssignmentError);
    });
});
...
//# sourceMappingURL=task-assignment.test.js.map